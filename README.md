...
If you wish to use a custom background, you can add a skybox to /lib/babylonjs/init.ts in the loadBackground function. Add 6 images to the public directory and name then appropriately per the [documentation](https://doc.babylonjs.com/features/featuresDeepDive/environment/skybox). Remember to import skybox.
